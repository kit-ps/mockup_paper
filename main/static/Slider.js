...
let expName = 'Slideshow';  // from the Builder filename that created this script
let expInfo = {
    'UserName': 'User01' };
...
psychoJS.start({
 ...
 expInfo: expInfo,
  resources: [
    {'name': 'target.png', 'path': 'static/target.png'},
    {'name': 'nontarget3.png', 'path': 'static/nontarget3.png'},
    {'name': 'nontarget5.png', 'path': 'static/nontarget5.png'},
    {'name': 'nontarget2.png', 'path': 'static/nontarget2.png'},
    {'name': 'nontarget1.png', 'path': 'static/nontarget1.png'},
    {'name': 'nontarget4.png', 'path': 'static/nontarget4.png'}
  ]
});
...
async function experimentInit() {
  ...
  text = new visual.TextStim({
    win: psychoJS.window,
    name: 'text',
    text: 'Please count the number of coat photos during the upcoming sequence of images while we register your brainwaves. \n \n Press "Space" to start',
    font: 'Open Sans',
    units: undefined, 
...
function StimuliRoutineBegin(snapshot) {
  return async function () {
    ...
    if (((r < 0.2) && (flage === 0))) {
        ...
        if ((r < 0.4)) {
            photo = "nontarget1.png";
            value = 1;
            flage = 0;
        } else {
            if ((r < 0.6)) {
                photo = "nontarget2.png";
                value = 1;
                flage = 0;
            } else {
                if ((r < 0.8)) {
                    photo = "nontarget3.png";
                    value = 1;
                    flage = 0;
                } else {
                    photo = "nontarget4.png";
                    value = 1;
                    flage = 0;
                }
            }
...
function final_step() {
  window.location.href = "/success?t=slider_v";
} 