...
let expName = 'Login Page';  // from the Builder filename that created this script
...
flowScheduler.add(psychoJS.gui.DlgFromDict({dictionary: expInfo,title: expName}));
...
async function experimentInit() {
  ...
  image_2 = new visual.ImageStim({
    ...
    image : 'img/target.png', mask : undefined,
