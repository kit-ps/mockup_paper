...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': 'nontarget3.png', 'path': 'nontarget3.png'},
    {'name': 'nontarget5.png', 'path': 'nontarget5.png'},
    {'name': 'nontarget2.png', 'path': 'nontarget2.png'},
    {'name': 'nontarget1.png', 'path': 'nontarget1.png'},
    {'name': 'nontarget4.png', 'path': 'nontarget4.png'}
  ]
});
