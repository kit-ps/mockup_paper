...
psychoJS.start({
 ...
 expInfo: expInfo,
  resources: [
    {'name': 'target.jpg', 'path': 'static/images/target.jpg'},
    {'name': 'nontarget1.jpg', 'path': 'static/images/nontarget1.jpg'},
    {'name': 'nontarget2.jpg', 'path': 'static/images/nontarget2.jpg'},
    {'name': 'nontarget3.jpg', 'path': 'static/images/nontarget3.jpg'}
  ]
});
...
async function experimentInit() {
  ...
  text = new visual.TextStim({
    win: psychoJS.window,
    name: 'text',
    text: 'Please look at the sequence of photos while we register your eye gaze. \n \n Press "Space" to start',
    font: 'Open Sans',
    units: undefined, 
...
function StimuliRoutineBegin(snapshot) {
  return async function () {
    ...
    if (((r < 0.25) && (flage === 0))) {
      ...
      if ((r < 0.5)) {
          photo = "nontarget1.jpg";
          value = 1;
          flage = 0;
      } else {
          if ((r < 0.75)) {
              photo = "nontarget2.jpg";
              value = 1;
              flage = 0;
          } else {
                  photo = "nontarget3.jpg";
                  value = 1;
                  flage = 0;
...
function StimuliRoutineEachFrame() {
  return async function () {
    ...
    frameRemains = delay + 2.0 - psychoJS.window.monitorFramePeriod * 0.75;  // most of one frame period left
...
function final_step() {
  window.location.href = "/success?t=slider_v2";
} 