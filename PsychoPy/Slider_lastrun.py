...
_key_resp_2_allKeys = []
# keep track of which components have finished
StimuliComponents = [text_2, key_resp_2]
...
while continueRoutine:
    ...
    if text_2.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > text_2.tStartRefresh + 1000-frameTolerance:
            # keep track of stop time/frame for later
...
_key_resp_3_allKeys = []
# keep track of which components have finished
s2Components = [text_3, key_resp_3]
...
while continueRoutine:
    ...
    if text_3.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > text_3.tStartRefresh + 1000-frameTolerance:
            # keep track of stop time/frame for later
